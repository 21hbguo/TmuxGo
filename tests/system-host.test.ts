...
test('returns local host metrics and dependency status', async (t) => {
  ...
  assert.equal(typeof data.net.sentBytes, 'number')
  assert.equal(typeof data.net.recvBytes, 'number')
  assert.equal(typeof data.net.daySentBytes, 'number')
  assert.equal(typeof data.net.dayRecvBytes, 'number')
  assert.equal(typeof data.net.last24hSentBytes, 'number')
  assert.equal(typeof data.net.last24hRecvBytes, 'number')
  assert.equal(typeof data.net.trackedMs, 'number')
  assert.equal(typeof data.net.windowMs, 'number')
})
