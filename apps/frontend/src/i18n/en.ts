export const en = {
  ...
  'sshPanel.sshConfigSaveFailed': 'Save SSH config failed',
  'sshPanel.configManaged': 'Connection settings are managed by ssh config; only overlay fields are editable here.',
  ...
  'sshPanel.quickAddInvalid': 'Invalid input, use user@host or host',
  'sshPanel.quickAddDone': 'Added {alias} to ssh config',
  'sshPanel.quickAddFailed': 'Add host failed',
  'sshPanel.resolve': 'Resolve (ssh -G)',
  ...
  'settings.editorWheelScrollLines': 'Wheel scroll lines',
  'settings.editorWheelScrollLines.auto': 'Default',
  ...
  'settings.updateRunning': 'Updating',
  ...
  'split.swap': 'Swap primary and secondary',
  'split.close': 'Exit split view',
  ...
  'file.downloadMany': 'Download {count} items',
  'file.downloadFailed': 'Download failed',
  'file.copy': 'Copy to...',
  'file.copyMany': 'Copy {count} items to...',
  'file.move': 'Move to...',
  'file.moveMany': 'Move {count} items to...',
  'file.targetDirectory': 'Target directory:',
  'file.copied': '{name} copied',
  'file.copiedMany': '{count} items copied',
  'file.moved': '{name} moved',
  'file.movedMany': '{count} items moved',
  'file.moveFailedMany': '{count} items failed to move',
  ...
  'file.moveToTrashMany': 'Move {count} items to trash',
  'file.movedToTrash': '{name} moved to trash',
  'file.movedToTrashMany': '{count} items moved to trash',
  ...
  'file.deleteConfirmMany': 'Delete {count} selected items?',
  'file.deleted': '{name} deleted',
  'file.deleteFailed': 'Delete failed',
  'file.deleteFailedMany': '{count} items failed to delete: {names}',
  ...
  'workspace.directoryTitle': 'Choose workspace directory',
  'workspace.selectDirectory': 'Select a directory on the left',
  'workspace.openDirectory': 'Open',
  'workspace.showHidden': 'Show hidden files',
  'workspace.hideHidden': 'Hide hidden files',
  ...
  'vnc.idle': 'Not connected',
  'vnc.disconnectUnclean': 'Connection lost',
  'vnc.connectTimeout': 'Connection timed out — check the network or display',
  ...
  'vnc.displayStop': 'Stop this display',
  ...
  'vnc.displayDetected': 'Running display detected: {display}',
  'vnc.customPort': 'Custom port',
  'vnc.viewOnly': 'View only',
  'vnc.sendCad': 'Send Ctrl+Alt+Del',
  'vnc.paste': 'Paste clipboard into remote',
  'vnc.clipboardDenied': 'Clipboard read denied by browser',
  'vnc.setupCheck': 'Detect VNC environment',
  'vnc.setupChecking': 'Detecting…',
  'vnc.setupInstall': 'Install & start x11vnc',
  'vnc.setupStart': 'Start VNC server',
  'vnc.setupInstalling': 'Installing…',
  'vnc.setupReady': 'VNC server ready — reconnect now',
  'vnc.setupManual': 'Run this on the host manually:',
  'vnc.setupNeedSudo': 'No passwordless sudo — run manually:',
  'vnc.setupMacos': 'macOS has built-in Screen Sharing: System Settings → General → Sharing → Screen Sharing',
  'vnc.setupWayland': 'Wayland session detected — install wayvnc or gnome-remote-desktop for your compositor',
  'vnc.setupUnsupported': 'Automatic setup is not supported on this OS',
