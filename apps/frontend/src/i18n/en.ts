export const en = {
  ...
  'settings.immersiveFullscreenDesc': 'Browser fullscreen immersion. Phones show a draggable back orb (double-tap to go back without leaving fullscreen); system back still exits fullscreen first.',
  ...
  'immersive.backOrbHint': 'Double-tap to go back · Hold to drag',
  'quick.copy': 'Copy',
  'quick.paste': 'Paste',
