...
export default function GlobalError({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <html lang="zh-CN">
      <body style={{ background: '#071224', color: '#c9d1d9', fontFamily: '"Maple Mono CN", monospace', display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', margin: 0 }}>
