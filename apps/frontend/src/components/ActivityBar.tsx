...
import { FiBell, FiFolder, FiGitBranch, FiGrid, FiList, FiSearch, FiServer, FiSettings } from 'react-icons/fi'
...
export function ActivityBar() {
  ...
  const items = [
    ...
    { id: 'tasks', label: t('tasks.title'), icon: FiList, onClick: () => window.dispatchEvent(new CustomEvent('tmuxgo-open-tasks')) },
