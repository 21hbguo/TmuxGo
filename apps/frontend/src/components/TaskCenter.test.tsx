...
describe('TaskCenter', () => {
  ...
  it('shows a structured task result', () => {
    render(React.createElement(TaskCenter, { onClose:vi.fn() }))
    fireEvent.click(screen.getByText('Upload file'))
    expect(screen.getByText(/"files"/)).toHaveTextContent('demo.txt')
  })
})
