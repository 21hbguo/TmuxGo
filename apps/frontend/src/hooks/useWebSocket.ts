...
export function useWebSocket() {
  ...
  },[clearConnectTimer,connect,ensureConnection,handleMessage,scheduleReconnect,sendPing,clearPongTimer,scheduleBackgroundClose])
