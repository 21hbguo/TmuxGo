...
export function useTerminalTouchScroll({ isMobile, onScroll, onTap, onTouchMovedChange, onSwipeLeft, onSwipeRight, onTwoFingerDoubleTap }: UseTerminalTouchScrollOptions) {
