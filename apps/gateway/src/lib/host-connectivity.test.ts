...
import { getHostConnectivity, recordHostConnectionFailure, removeHostConnectivity, setHostConnectivity } from './host-connectivity.js'

test('records the latest connection failure while retaining host diagnostics', () => {
  setHostConnectivity('edge', { status: 'online', latencyMs: 18, lastCheckedAt: '2026-08-02T00:00:00.000Z', dependencies: { tmux: true } })
